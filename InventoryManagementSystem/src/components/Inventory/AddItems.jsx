...
export default function AddItems() {
  ...
  return (
    <div className="p-6 border-gray-800 bg-gray-300 text-gray-800 rounded-lg w-1/2 mx-auto">
      <h2 className="text-2xl font-semibold mb-4 text-center">Add New Product</h2>
      {error && <p className="text-red-400 text-center mb-4">{error}</p>}
      {!user ? (
        <p className="text-center text-gray-700">Loading...</p>
      ) : (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 shadow-3xl">
          ...
          <div className="flex flex-col">
            <label className="text-gray-800 font-bold mb-1">Stock Quantity</label>
            <input
              type="number"
              className="border border-gray-600 bg-gray-900 text-gray-300 rounded-md w-full p-2 focus:outline-none focus:ring-2 focus:ring-blue-400 block px-4 py-2 focus:border-blue-300"
          ...
          <div className="flex flex-col">
            <label className="text-gray-800 font-bold mb-1">Select Supplier</label>
            <select
              className="border border-gray-600 bg-gray-900 text-gray-300 rounded-md w-full p-2 focus:outline-none focus:ring-2 focus:ring-blue-400 appearance-none"
          ...
          <div className="flex flex-col">
            <label className="text-gray-800 font-bold mb-1">Select Category</label>
            <select
              className="border border-gray-600 bg-gray-900 text-gray-300 rounded-md w-full p-2 pl-3 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-400 appearance-none"
