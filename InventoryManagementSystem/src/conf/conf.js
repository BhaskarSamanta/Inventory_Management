const conf= {
    ...
    appwrite_Pruduct_CollectionId: String(import.meta.env.VITE_APPWRITE_PRODUCT_COLLECTION_ID),
    appwrite_Supplier_CollectionId: String(import.meta.env.VITE_APPWRITE_SUPPLIER_COLLECTION_ID),
