...
const HomePage = () => {
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-blue-500 to-purple-100">
      <div className="w-full h-hull text-center mt-10">
        <h1 className="text-3xl font-bold font-mono text-white mb-8 justify-start">
          Welcome to InventoryPro
        </h1>
        <div className="flex justify-between w-full">
        <div className=" flex-wrap flex h-1/2 w-2/3 ml-10 hover:scale-105 ease-in-out transition-transform bg-gradient-to-br from-purple-900 to-blue-900 border-b-2 shadow-sm border-blue-950 rounded-3xl">
          <p className="text-purple-400 ml-6 mr-2 mt-4 mb-4 text-left text-xl">
        ...
        <div className=" flex-wrap flex h-2/3 ml-10 scale-105 hover:scale-110 ease-in-out transition-transform bg-transparent rounded-3xl mr-10">
          <p className="text-purple-700 ml-6 mr-2 mt-4 mb-4 text-left text-xl">
